...
gauss_params_2Q_1 = {
    ...
    't_final': Qty(value=tswap_10_20, min_val=0.5 * tswap_10_20, max_val=1.5 * tswap_10_20, unit="s"),
    'sigma': Qty(value=tswap_10_20 / 4, min_val=tswap_10_20 / 8, max_val=tswap_10_20 / 2, unit="s"),
