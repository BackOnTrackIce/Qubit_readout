...
drive_freq_qubit = 7646249458.989598
drive_freq_resonator = 7646943470.423654
...
drive_freq_qubit = 9512034954.805803
drive_freq_resonator = 9511844098.396688
carrier_freq = [drive_freq_qubit, drive_freq_resonator]
carrier_parameters = {
            "Q":{"freq": Qty(value=carrier_freq[0], min_val=0.0, max_val=10e9, unit="Hz 2pi"),
            "framechange": Qty(value=0.0, min_val=-np.pi, max_val=3 * np.pi, unit="rad")},
...
opt = OptimalControl(
    ...
    options={"maxfun":250},
    run_name="swap_dissipative",
    fid_func_kwargs={"psi_0":excited_state}
)
exp.set_opt_gates(["swap[0, 1]"])
opt.set_exp(exp)
...
#%%
parameter_map.store_values("Test_swap_with_dissipation.c3log")
