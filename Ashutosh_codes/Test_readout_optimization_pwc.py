...
def frameOfDrive(exp, psi_list, freq, spacing):
    model = exp.pmap.model
...
def plotIQ(
    ...
    psi_list_0 =  frameOfDrive(exp, psi_list, resonator_frequency, spacing)
    ...
    psi_list = psi_list[::spacing]
    psi_list_1 =  frameOfDrive(exp, psi_list, resonator_frequency, spacing)
...
exp.write_config("Test_readout_optimization.hjson")

opt.optimize_controls()
print(opt.current_best_goal)
print(parameter_map.print_parameters())

parameter_map.store_values("Test_readout_optimization_values.c3log")
