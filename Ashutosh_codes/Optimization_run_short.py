...
plotPopulation(exp=exp, psi_init=init_state, sequence=sequence, states_to_plot=states_to_plot, usePlotly=False, filename="Short_swap_Before_optimisation.png")
...
plotPopulation(exp=exp, psi_init=init_state, sequence=sequence, usePlotly=False, filename="Short_swap_After_optimization.png")
plotPopulation(exp=exp, psi_init=init_state, sequence=sequence, usePlotly=False, states_to_plot=states_to_plot, filename="Short_swap_After_optimization_selected.png")

pmap.store_values("current_vals_short.c3log")
