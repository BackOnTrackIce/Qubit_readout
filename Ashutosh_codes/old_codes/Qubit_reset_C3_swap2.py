...
swap_params = {
    "amp": Qty(value=0.5,min_val=0.001,max_val=1.0,unit="V"),
    "t_final": Qty(value=t_swap_gate,min_val=1e-9,max_val=30e-9,unit="s"),
...
plotPopulation(exp=exp, psi_init=init_state, sequence=sequence, states_to_plot=states_to_plot, usePlotly=False, filename=f"Before_optimisation.png")
...
# %%
plotPopulation(exp=exp, psi_init=init_state, sequence=sequence, usePlotly=False, filename="After_optimization.png")
plotPopulation(exp=exp, psi_init=init_state, sequence=sequence, usePlotly=False, states_to_plot=states_to_plot, filename="After_optimization_selected.png")
